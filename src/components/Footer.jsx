			...
			<div className="container d-flex flex-wrap">
				<main className="col-12">
					...
					<article className="col-12 col-lg-6 text-center">
						<NavLink to="/" className="logo d-block m-auto" title="Go To Home">
							<img src={logoImg} className="w-100 h-100" alt="logo image" />
						</NavLink>
						<p className="mt-3">
					...
					<div className="address col-12 col-lg text-center">
						...
						<ul className="d-flex flex-column align-items-center align-items-lg-start ps-0 gap-2">
							...
							<li className="c-gray">ahmedmaher.dev1@gmail.com</li>
							<li>
								<a
